...
class Settings(BaseSettings):
    ...
    SERVICE_DESCRIPTION: str = "A FastAPI service providing in-memory database operations"
    ...
    def configure_for_environment(self) -> None:
        ...
        if self.ENVIRONMENT == "production":
            ...
            if isinstance(self.CORS_ORIGINS, str) and self.CORS_ORIGINS == "*":
                raise ValueError("CORS_ORIGINS must be explicitly specified in production")
